document.addEventListener('DOMContentLoaded', function() {
    const apiUrl = 'https://angrenupt.pythonanywhere.com/blogpage/'; // Replace with your API endpoint
        ...
        blogItems.forEach(item => {
            ...
            blogItem.innerHTML = `
                <div class="blog-item">
                    ...
                    <div class="blog-desc">
                        <p>${item.description[currentLang].toString().length < 125 ? item.description[currentLang] : item.description[currentLang].slice(0, 125).concat("...")}</p>
                    </div>
                    <div id="see_more_from_blogpage" class="blog-button">
                        <a class="hover-btn-new orange" href="blog-single.html"><span>${currentLang == "en" ? "Read more" : currentLang == "ru" ? "Подробнее" : "Batafsil"}<span></a>
                    </div>
                </div>
            `;
